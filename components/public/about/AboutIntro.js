...
export default function AboutIntro({ data, meta, projectsCount }) {
      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <motion.div variants={slideLeft} className="space-y-8 min-w-0">
              ...
              <div 
                ...
                dangerouslySetInnerHTML={{ __html: meta?.content ? meta.content.replace(/&nbsp;/g, ' ') : '' }}
              />
            </motion.div>

            <motion.div variants={slideUp} className="grid grid-cols-2 gap-4 md:gap-8 pt-8 border-t border-zinc-100">
          ...
          >
            <motion.div 
              ...
              className="absolute -top-6 -right-6 w-32 h-32 bg-[#0e2188]/5 rounded-full -z-10" 
            />
            ...
            <motion.div 
              ...
              className="absolute -bottom-6 -left-4 md:-bottom-8 md:-left-8 bg-[#0e2188] p-6 md:p-8 text-white max-w-[160px] md:max-w-[200px] shadow-xl z-20"
            >
