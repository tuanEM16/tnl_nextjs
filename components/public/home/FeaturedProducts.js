...
export default function FeaturedProducts() {
  ...
  return (
    <section className="py-32 bg-white font-sans border-y border-zinc-100 select-none overflow-hidden">
      <Container>
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start justify-between min-h-[600px]">
            ...
            <motion.div variants={slideLeft} className="lg:w-[45%] sticky top-32">
            ...
            <motion.div variants={slideUp} className="lg:w-[28%] flex items-center justify-center">
              <AnimatePresence mode="wait">
                {hoveredProduct && (
                  <motion.div 
            ...
            <motion.div variants={slideRight} className="lg:w-[22%] h-[600px] flex flex-col">
                  ...
                  {products.map((p) => (
                    ...
                    >
                      ...
                      {hoveredProduct?.id === p.id && (
                        <motion.span layoutId="activeArrowProduct" className="text-[#e33127]">
