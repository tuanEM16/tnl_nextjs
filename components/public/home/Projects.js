...
function ProjectCard({ item, isActive }) {
  return (
    <div className="relative w-full h-full overflow-hidden rounded-sm bg-white shadow-2xl">
      <img
    ...
    <section className="relative py-32 bg-white text-[#0e2188] overflow-hidden font-sans select-none">
      ...
      >
        ...
        <div className="container mx-auto px-6 md:px-12 mb-20 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <motion.div variants={slideLeft} className="max-w-2xl">
          ...
          <motion.div variants={slideLeft} className="flex items-center gap-8">
        ...
        <motion.div variants={slideUp} className="flex justify-center items-center gap-4 mt-12">
          {data.map((_, i) => (
            <button
              key={i}
              onClick={() => goTo(i)}
        ...
        {/* Navigation Controls */}
        <motion.div variants={slideUp} className="flex justify-center gap-12 mt-12 md:hidden">
